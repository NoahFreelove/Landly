        ...
        {!loading && dashData && (
          <>
            ...
            <button
              ...
              className="group bg-surface-card border border-[#2b2839] rounded-lg p-4 flex items-center gap-4 hover:border-primary/40 hover:bg-primary/[0.03] transition-all cursor-pointer text-left w-full"
            >
              <div className="w-10 h-10 rounded-full bg-amber-500/10 border border-amber-500/20 flex items-center justify-center flex-shrink-0 group-hover:bg-amber-500/20 transition-colors">
                <svg
              ...
              <div className="flex-1">
                <h4 className="text-xs font-bold uppercase tracking-wider text-zinc-200 group-hover:text-amber-300 transition-colors">
                  Rate Your Neighbor
                </h4>
                <p className="text-[10px] text-zinc-500 mt-0.5">
                  Submit a citizen evaluation to adjust social credit scores
                </p>
              </div>
              <svg
